...
public class CoffeeController {
    ...
    public ResponseEntity postCoffee(@Valid @RequestBody CoffeePostDto coffeePostDto) {
        ...
        return new ResponseEntity<>(mapper.coffeeToResponseDto(response), HttpStatus.CREATED);
    }
    ...
    public ResponseEntity patchCoffee(@PathVariable("coffee-id") @Positive long coffeeId,
        ...
        return new ResponseEntity<>(mapper.coffeeToResponseDto(response), HttpStatus.OK);
    }
    ...
    public ResponseEntity getCoffees() {
        ...
        List<CoffeeResponseDto> response = coffees.stream()
                .map(coffee -> mapper.coffeeToResponseDto(coffee))
